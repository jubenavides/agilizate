...
public class programaClienteBean extends BaseBean implements Serializable {
    ...
    public void init() {
        ...
        this.programa.setProgramaClientePK(new ProgramaClientePK());
    }
    ...
    public void buscar(Integer codigo) {
    ...
    public String generaDescripcion() {
        String cadena;
        cadena = " Programa " + this.programa.getProgramaClientePK().getCodPrograma() + " Cliente "
                + this.cliente.getNombre() + " " + this.cliente.getApellido() + " Duracion "
                + this.programa.getTotalDuracion() + " dias";
        return cadena;
    }
    ...
    {
        try {
            this.programaClienteService.eliminar(this.programaSel.getProgramaClientePK());
